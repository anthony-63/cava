...
public final class plugins extends ListResourceBundle {
    protected final Object[][] getContents() {
        return new Object[][] {
            ...
            { "compress.usage", "  --compress <compress>     Compression to use in compressing resources:\n                            Accepted values are:\n                            zip-[0-9], where zip-0 provides no compression,\n                            and zip-9 provides the best compression.\n                            Default is zip-6." },
            { "compress.warn.argumentdeprecated", "Warning: The {0} argument for --compress is deprecated and may be removed in a future release" },
